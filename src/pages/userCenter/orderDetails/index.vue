<template>
  <div id="order" class="order">
    ...
    <!-- <div class="container" v-if="chargeType != '充值'">
      <div class="record">
        <div class="subTitle">
          <div class="hd">流水号</div>
